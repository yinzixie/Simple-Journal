...
final class LocationPickerViewController: UIViewController {
	...
	public override func loadView() { //open
		view = mapView
	}
	
	public override func viewDidLoad() { //open
		super.viewDidLoad()
    ...
    override public func viewWillLayoutSubviews() { //open
    ...
    override public func viewDidLayoutSubviews() { //open
